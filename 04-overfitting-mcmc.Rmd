...
```{r e7m3-2, include = FALSE, cache = TRUE, eval = FALSE}
...
```{r e7m4-2, include = FALSE, cache = TRUE, eval = FALSE}
...
```{r e7h1-2, echo = FALSE, eval = FALSE}
...
```{r e7h2-3, echo = FALSE, eval = FALSE}
tr_seq <- tibble(tax_rate = seq(0, 40, length.out = 100)) %>%
  mutate(tax_rate2 = tax_rate ^ 2,
         tax_rate = (tax_rate - mean(Laffer$tax_rate)) / sd(Laffer$tax_rate),
         tax_rate2 = (tax_rate2 - mean(Laffer$tax_rate ^ 2)) /
...
```{r e7h3-intro, message = FALSE, echo = FALSE, wrap = "table-question", eval = FALSE}
library(kableExtra)
...
```{r e7h4-1, message = FALSE, out.width = "40%", eval = FALSE}
library(dagitty)
library(ggdag)
...
```{r e7h4-2, cache = TRUE, eval = FALSE}
...
```{r e7h5-2, warning = FALSE, eval = FALSE}
...
```{r e7h5-3, echo = FALSE, eval = FALSE}
plot_comp <- comp %>%
...
```{r e7h5-fox-dag, out.width = "40%", echo = FALSE, eval = FALSE}
...
```{r e8h4-8, echo = FALSE, eval = FALSE}
