...
tibble(group = seq_len(n),
  ...
  annotate(geom = "text", x = 1, y = -3, hjust = 0, vjust = 1,
           label = "Embryo", family = "Source Sans Pro") +
  annotate(geom = "text", x = 1, y = 275, hjust = 0, vjust = 0,
           label = "World's tallest person (272cm)") +
  coord_cartesian(ylim = c(-25, 300)) +
  labs(x = "Year", y = "Height", family = "Source Sans Pro")
```
