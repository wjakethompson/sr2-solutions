...
```{r w3h4-4, eval = !file.exists(here("fits", "hw3", "w3h4-sim.rds"))}
...
```{r w3h4-5, include = FALSE, eval = file.exists(here("fits", "hw3", "w3h4-sim.rds"))}
sim_results <- read_rds(here("fits", "hw3", "w3h4-sim.rds"))
```
