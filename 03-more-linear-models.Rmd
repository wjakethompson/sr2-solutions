...
```{r e6m2-3, out.width = "40%", echo = FALSE, fig.align = ""}
...
<div class="figure" style="text-align: center">
```{r e6m3-1, out.width = "40%", echo = FALSE, fig.align = ""}
...
# Plots -----
padding <- 30
ggplot(dag1, aes(x = x, y = y, xend = xend, yend = yend)) +
  geom_dag_text(color = "black", size = 10) +
  geom_dag_edges(edge_color = "black", edge_width = 2,
                 arrow_directed = grid::arrow(length = grid::unit(15, "pt"),
                                              type = "closed")) +
...
ggplot(dag2, aes(x = x, y = y, xend = xend, yend = yend)) +
  ...
  theme_void() +
  theme(plot.margin = unit(c(0, 0, 0, padding), "pt"))
ggplot(dag3, aes(x = x, y = y, xend = xend, yend = yend)) +
  geom_dag_text(color = "black", size = 10) +
  geom_dag_edges(edge_color = "black", edge_width = 2,
                 arrow_directed = grid::arrow(length = grid::unit(15, "pt"),
                                              type = "closed")) +
  theme_void() +
  theme(plot.margin = unit(c(0, padding, 0, 0), "pt"))
ggplot(dag4, aes(x = x, y = y, xend = xend, yend = yend)) +
  geom_dag_text(color = "black", size = 10) +
  geom_dag_edges(edge_color = "black", edge_width = 2,
                 arrow_directed = grid::arrow(length = grid::unit(15, "pt"),
                                              type = "closed")) +
